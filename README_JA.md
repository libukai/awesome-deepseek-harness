...
- [dsh-movein](https://github.com/sjh9714/dsh-movein)：DSH のネイティブ設定画面または CLI から Claude Code 設定を確認して移行する。Skill、Command、Agent、hooks、Permission Rule、MCP に対応し、Codex と OpenCode も副次的な移行元として保持する。衝突検査、Backup、Restore、`doctor` を備え、Session 履歴は対象外。MIT `v0.13.4`、まだ新しいため初期段階。
