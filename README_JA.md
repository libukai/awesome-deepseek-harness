...
- [dsh-plugin-no-workspace](https://github.com/SpookySandwich/dsh-plugin-no-workspace)：DSH の会話をワークスペース外で作成、またはデータを失わずに切り離し、「未分類」フォルダーを表示せずサイドバー直下に配置する。MIT、npm `1.0.0`、DSH `0.1.1-rc.2` で検証済み。88 件の Test と実 Desktop E2E を含む。
