...
- [dsplugin.app](https://dsplugin.app/)：非公式のコミュニティ向け DeepSeek Harness プラグインディレクトリ / レジストリ。インストール前にソースと Manifest/`dsh.bundle` を確認してください。
