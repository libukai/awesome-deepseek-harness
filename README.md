...
- [nickkkkkk123123/dsh-whale-girl](https://github.com/nickkkkkk123123/dsh-whale-girl)：鲸鱼娘桌宠挂件：实时余额/用量/上下文占用、中键弹弓抛掷、彩蛋气泡与省电模式；346KB 安装包、零额外进程（实测空闲 CPU 影响约 0.6%）。
