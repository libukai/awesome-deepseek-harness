...
- [dsh-skill-hub](https://github.com/cheshireez/dsh-skill-hub): in-GUI skill hub for DSH — browse, search, toggle, inspect, diagnose and scaffold local skills from the official ctx.skills registry, plus a skill market with tracked source sync; MIT, npm \`dsh-skill-hub@0.2.2\`.
