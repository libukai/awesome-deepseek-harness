...
| [DeepSeek Harness for macOS](https://github.com/qingtan-labs/deepseek-harness-macos) | macOS 13+ · Native AppKit / WebKit · Universal | Lightweight Dock and menu bar controller for the official local DSH Web UI, with saved browser / in-app presentation, exact existing-tab reuse, service health and ownership protection, and an optional native WebKit window. The `v1.0.0` ZIP supports both Intel and Apple silicon; it is ad-hoc signed and not notarized |
