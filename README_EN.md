...
- [dsh-win32](https://github.com/sjh9714/dsh-win32), native persistent shell and Workspace Write sandbox presets for Windows without WSL; MIT `v0.15.1`, verified by 103 tests and Windows restricted-token CI. Sandboxed sessions use busybox-w32 and unrestricted sessions use Git Bash, with GBK / UTF-16 reads and `doctor` setup diagnostics. It remains limited to DSH `>=0.1.0-rc.5 <0.1.0-rc.7`, and Windows console processes may escalate to forced termination after graceful termination fails.
...
- [dsh-movein](https://github.com/sjh9714/dsh-movein), previews and moves supported Claude Code, Codex, and OpenCode setup into DSH; covers skills, commands, agents, instructions, and local or remote MCP servers with OpenCode V1 / V2 JSONC precedence, collision checks, backups, restore, and `doctor`. Sessions, OpenCode permissions, and plugins remain out of scope. MIT `v0.7.2`, still new and marked Early.
