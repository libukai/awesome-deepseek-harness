...
- [dsh-plugin-no-workspace](https://github.com/SpookySandwich/dsh-plugin-no-workspace): creates DSH conversations outside workspaces or detaches them without data loss, rendering them as top-level sidebar items without an “Ungrouped” folder; MIT and npm `1.0.0`, verified on DSH `0.1.1-rc.2` with 88 tests and real desktop E2E coverage.
