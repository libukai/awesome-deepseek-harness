...
- [dsh-movein](https://github.com/sjh9714/dsh-movein): previews and imports Claude Code setup through a native DSH settings screen or CLI, covering skills, commands, agents, hooks, permission rules, and MCP. Codex and OpenCode remain secondary origins, with collision checks, backups, restore, and `doctor`. Session history remains out of scope. MIT `v0.13.1`, still new and marked Early.
